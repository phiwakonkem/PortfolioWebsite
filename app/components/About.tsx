                ...
                {profile.profileImage && profile.profileImage !== "/images/profile.jpg" ? (
                  ...
                  >
                    <span
                      ...
                      style={{ fontSize: "4rem", fontWeight: 800, color: "var(--accent)" }}
                    >
                      PM
                    </span>
                  </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "0.9rem" }}>
                ...
                {editing === "email" ? (
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", flex: 1 }}>
                    ...
                    <button onClick={() => startEdit("email")} style={{ background: "none", border: "none", cursor: "pointer", color: "var(--border)", padding: 0 }}
                      onMouseEnter={(e) => (e.currentTarget.style.color = "var(--accent)")}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "0.9rem" }}>
                ...
                {editing === "phone" ? (
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", flex: 1 }}>
                    ...
                    <button onClick={() => startEdit("phone")} style={{ background: "none", border: "none", cursor: "pointer", color: "var(--border)", padding: 0 }}
                      onMouseEnter={(e) => (e.currentTarget.style.color = "var(--accent)")}
                      onMouseLeave={(e) => (e.currentTarget.style.color = "var(--border)")}>
                      <Pencil size={12} />
                    </button>
            ...
            {editing === "bio" ? (
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  <button onClick={saveEdit} style={{ background: "var(--accent)", color: "#000", border: "none", borderRadius: "6px", padding: "6px 16px", cursor: "pointer", fontWeight: 600, fontSize: "0.85rem" }}>Save</button>
                  <button onClick={cancelEdit} style={{ background: "var(--bg-card)", color: "var(--text-muted)", border: "1px solid var(--border)", borderRadius: "6px", padding: "6px 16px", cursor: "pointer", fontSize: "0.85rem" }}>Cancel</button>
                </div>
              </div>
            ) : (
              <div style={{ position: "relative" }}>
                <p style={{ color: "var(--text-muted)", lineHeight: 1.8, fontSize: "1rem" }}>{profile.bio}</p>
                <button
